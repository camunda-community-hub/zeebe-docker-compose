...
The `docker-compose.yml` files in this repository can be used to start a Zeebe broker; optionally with Simple Monitor, or with Operate, along with the Elasticsearch and Kibana containers that it needs.
